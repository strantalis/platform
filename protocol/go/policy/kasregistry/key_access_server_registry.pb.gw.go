...
func request_KeyAccessServerRegistryService_GetKeyAccessServerByIdentifier_0(ctx context.Context, marshaler runtime.Marshaler, client KeyAccessServerRegistryServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetKeyAccessServerByIdentifierRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.GetKeyAccessServerByIdentifier(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_KeyAccessServerRegistryService_GetKeyAccessServerByIdentifier_0(ctx context.Context, marshaler runtime.Marshaler, server KeyAccessServerRegistryServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetKeyAccessServerByIdentifierRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetKeyAccessServerByIdentifier(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterKeyAccessServerRegistryServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server KeyAccessServerRegistryServiceServer) error {
	...
	mux.Handle("GET", pattern_KeyAccessServerRegistryService_GetKeyAccessServerByIdentifier_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/policy.kasregistry.KeyAccessServerRegistryService/GetKeyAccessServerByIdentifier", runtime.WithHTTPPathPattern("/key-access-servers/identifier/{identifier}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_KeyAccessServerRegistryService_GetKeyAccessServerByIdentifier_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_KeyAccessServerRegistryService_GetKeyAccessServerByIdentifier_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterKeyAccessServerRegistryServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client KeyAccessServerRegistryServiceClient) error {
	...
	mux.Handle("GET", pattern_KeyAccessServerRegistryService_GetKeyAccessServerByIdentifier_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/policy.kasregistry.KeyAccessServerRegistryService/GetKeyAccessServerByIdentifier", runtime.WithHTTPPathPattern("/key-access-servers/identifier/{identifier}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_KeyAccessServerRegistryService_GetKeyAccessServerByIdentifier_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_KeyAccessServerRegistryService_GetKeyAccessServerByIdentifier_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 1}, []string{"key-access-servers", "identifier"}, ""))
...
var (
	...
	forward_KeyAccessServerRegistryService_GetKeyAccessServerByIdentifier_0 = runtime.ForwardResponseMessage
