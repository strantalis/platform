...
type GetKeyAccessServerByIdentifierRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetKeyAccessServerByIdentifierRequest) Reset() {
	*x = GetKeyAccessServerByIdentifierRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetKeyAccessServerByIdentifierRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetKeyAccessServerByIdentifierRequest) ProtoMessage() {}

func (x *GetKeyAccessServerByIdentifierRequest) ProtoReflect() protoreflect.Message {
	mi := &file_policy_kasregistry_key_access_server_registry_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetKeyAccessServerByIdentifierRequest.ProtoReflect.Descriptor instead.
func (*GetKeyAccessServerByIdentifierRequest) Descriptor() ([]byte, []int) {
	return file_policy_kasregistry_key_access_server_registry_proto_rawDescGZIP(), []int{2}
}

func (x *GetKeyAccessServerByIdentifierRequest) GetIdentifier() string {
	if x != nil {
		return x.Identifier
	}
	return ""
...
type GetKeyAccessServerByIdentifierResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetKeyAccessServerByIdentifierResponse) Reset() {
	*x = GetKeyAccessServerByIdentifierResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetKeyAccessServerByIdentifierResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetKeyAccessServerByIdentifierResponse) ProtoMessage() {}

func (x *GetKeyAccessServerByIdentifierResponse) ProtoReflect() protoreflect.Message {
	mi := &file_policy_kasregistry_key_access_server_registry_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetKeyAccessServerByIdentifierResponse.ProtoReflect.Descriptor instead.
func (*GetKeyAccessServerByIdentifierResponse) Descriptor() ([]byte, []int) {
	return file_policy_kasregistry_key_access_server_registry_proto_rawDescGZIP(), []int{3}
}

func (x *GetKeyAccessServerByIdentifierResponse) GetKeyAccessServer() *policy.KeyAccessServer {
	if x != nil {
		return x.KeyAccessServer
	}
	return nil
...
type CreateKeyAccessServerRequest struct {
	...
	// This is the identifier of the key access server and can't be changed
...
func (x *CreateKeyAccessServerRequest) GetIdentifier() string {
	if x != nil {
		return x.Identifier
	}
	return ""
...
var file_policy_kasregistry_key_access_server_registry_proto_rawDesc = []byte{
	...
	0x73, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x22, 0x4f, 0x0a, 0x25, 0x47, 0x65, 0x74, 0x4b, 0x65,
	0x79, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x42, 0x79, 0x49,
	0x64, 0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x12, 0x26, 0x0a, 0x0a, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x42, 0x06, 0xba, 0x48, 0x03, 0xc8, 0x01, 0x01, 0x52, 0x0a, 0x69, 0x64,
	0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x22, 0x6d, 0x0a, 0x26, 0x47, 0x65, 0x74, 0x4b,
	0x65, 0x79, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x42, 0x79,
	...
	0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x73, 0x22, 0xcf, 0x01,
	...
	0x65, 0x79, 0x12, 0x26, 0x0a, 0x0a, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x42, 0x06, 0xba, 0x48, 0x03, 0xc8, 0x01, 0x01, 0x52, 0x0a,
	0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x12, 0x33, 0x0a, 0x08, 0x6d, 0x65,
	...
	0x64, 0x0a, 0x1d, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4b, 0x65, 0x79, 0x41, 0x63, 0x63, 0x65,
	...
	0x65, 0x72, 0x76, 0x65, 0x72, 0x22, 0x85, 0x02, 0x0a, 0x1c, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	...
	0x72, 0x32, 0x84, 0x08, 0x0a, 0x1e, 0x4b, 0x65, 0x79, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x53,
	...
	0x2f, 0x7b, 0x69, 0x64, 0x7d, 0x12, 0xcc, 0x01, 0x0a, 0x1e, 0x47, 0x65, 0x74, 0x4b, 0x65, 0x79,
	0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x42, 0x79, 0x49, 0x64,
	0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x12, 0x39, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63,
	...
	,
	...
	0x2f, 0x6b, 0x65, 0x79, 0x2d, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x2d, 0x73, 0x65, 0x72, 0x76,
	0x65, 0x72, 0x73, 0x2f, 0x7b, 0x69, 0x64, 0x7d, 0x42, 0xdb, 0x01, 0x0a, 0x16, 0x63, 0x6f, 0x6d,
	0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6b, 0x61, 0x73, 0x72, 0x65, 0x67, 0x69, 0x73,
...
var file_policy_kasregistry_key_access_server_registry_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_policy_kasregistry_key_access_server_registry_proto_goTypes = []interface{}{
	...
	(*GetKeyAccessServerByIdentifierRequest)(nil),  // 2: policy.kasregistry.GetKeyAccessServerByIdentifierRequest
	(*GetKeyAccessServerByIdentifierResponse)(nil), // 3: policy.kasregistry.GetKeyAccessServerByIdentifierResponse
	...
	(*policy.KeyAccessServer)(nil),                 // 12: policy.KeyAccessServer
	(*policy.PublicKey)(nil),                       // 13: policy.PublicKey
...
var file_policy_kasregistry_key_access_server_registry_proto_depIdxs = []int32{
	12, // 0: policy.kasregistry.GetKeyAccessServerResponse.key_access_server:type_name -> policy.KeyAccessServer
	12, // 1: policy.kasregistry.GetKeyAccessServerByIdentifierResponse.key_access_server:type_name -> policy.KeyAccessServer
	12, // 2: policy.kasregistry.ListKeyAccessServersResponse.key_access_servers:type_name -> policy.KeyAccessServer
	13, // 3: policy.kasregistry.CreateKeyAccessServerRequest.public_key:type_name -> policy.PublicKey
	14, // 4: policy.kasregistry.CreateKeyAccessServerRequest.metadata:type_name -> common.MetadataMutable
	12, // 5: policy.kasregistry.CreateKeyAccessServerResponse.key_access_server:type_name -> policy.KeyAccessServer
	13, // 6: policy.kasregistry.UpdateKeyAccessServerRequest.public_key:type_name -> policy.PublicKey
	14, // 7: policy.kasregistry.UpdateKeyAccessServerRequest.metadata:type_name -> common.MetadataMutable
	15, // 8: policy.kasregistry.UpdateKeyAccessServerRequest.metadata_update_behavior:type_name -> common.MetadataUpdateEnum
	12, // 9: policy.kasregistry.UpdateKeyAccessServerResponse.key_access_server:type_name -> policy.KeyAccessServer
	12, // 10: policy.kasregistry.DeleteKeyAccessServerResponse.key_access_server:type_name -> policy.KeyAccessServer
	4,  // 11: policy.kasregistry.KeyAccessServerRegistryService.ListKeyAccessServers:input_type -> policy.kasregistry.ListKeyAccessServersRequest
	0,  // 12: policy.kasregistry.KeyAccessServerRegistryService.GetKeyAccessServer:input_type -> policy.kasregistry.GetKeyAccessServerRequest
	2,  // 13: policy.kasregistry.KeyAccessServerRegistryService.GetKeyAccessServerByIdentifier:input_type -> policy.kasregistry.GetKeyAccessServerByIdentifierRequest
	6,  // 14: policy.kasregistry.KeyAccessServerRegistryService.CreateKeyAccessServer:input_type -> policy.kasregistry.CreateKeyAccessServerRequest
	8,  // 15: policy.kasregistry.KeyAccessServerRegistryService.UpdateKeyAccessServer:input_type -> policy.kasregistry.UpdateKeyAccessServerRequest
	10, // 16: policy.kasregistry.KeyAccessServerRegistryService.DeleteKeyAccessServer:input_type -> policy.kasregistry.DeleteKeyAccessServerRequest
	5,  // 17: policy.kasregistry.KeyAccessServerRegistryService.ListKeyAccessServers:output_type -> policy.kasregistry.ListKeyAccessServersResponse
	1,  // 18: policy.kasregistry.KeyAccessServerRegistryService.GetKeyAccessServer:output_type -> policy.kasregistry.GetKeyAccessServerResponse
	3,  // 19: policy.kasregistry.KeyAccessServerRegistryService.GetKeyAccessServerByIdentifier:output_type -> policy.kasregistry.GetKeyAccessServerByIdentifierResponse
	7,  // 20: policy.kasregistry.KeyAccessServerRegistryService.CreateKeyAccessServer:output_type -> policy.kasregistry.CreateKeyAccessServerResponse
	9,  // 21: policy.kasregistry.KeyAccessServerRegistryService.UpdateKeyAccessServer:output_type -> policy.kasregistry.UpdateKeyAccessServerResponse
	11, // 22: policy.kasregistry.KeyAccessServerRegistryService.DeleteKeyAccessServer:output_type -> policy.kasregistry.DeleteKeyAccessServerResponse
...
func file_policy_kasregistry_key_access_server_registry_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_policy_kasregistry_key_access_server_registry_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetKeyAccessServerByIdentifierRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_policy_kasregistry_key_access_server_registry_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetKeyAccessServerByIdentifierResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
