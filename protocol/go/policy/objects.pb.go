...
var file_policy_objects_proto_rawDesc = []byte{
	...
	0x04, 0x10, 0x05, 0x52, 0x07, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x73, 0x22, 0xa8, 0x02, 0x0a,
	0x06, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x3b, 0x0a, 0x08, 0x73, 0x74, 0x61, 0x6e, 0x64,
	...
	0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x06, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x12, 0x12,
	...
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x4d, 0x65,
	0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x52, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61,
	0x22, 0xa5, 0x01, 0x0a, 0x17, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x65, 0x64, 0x52,
	...
	0x52, 0x08, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x2c, 0x0a, 0x08, 0x6d, 0x65,
	...
	0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0xdf, 0x02, 0x0a, 0x0d, 0x41, 0x73, 0x79,
	...
	0x65, 0x79, 0x43, 0x74, 0x78, 0x12, 0x26, 0x0a, 0x0f, 0x70, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65,
	0x5f, 0x6b, 0x65, 0x79, 0x5f, 0x63, 0x74, 0x78, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0d,
	0x70, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x4b, 0x65, 0x79, 0x43, 0x74, 0x78, 0x12, 0x4d, 0x0a,
	0x0f, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e,
	...
	0x52, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0xa9, 0x02, 0x0a, 0x0c, 0x53,
	...
	0x0c, 0x52, 0x06, 0x6b, 0x65, 0x79, 0x43, 0x74, 0x78, 0x12, 0x4d, 0x0a, 0x0f, 0x70, 0x72, 0x6f,
	0x76, 0x69, 0x64, 0x65, 0x72, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x06, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x24, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6b, 0x65, 0x79, 0x6d,
...
var file_policy_objects_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_policy_objects_proto_goTypes = []interface{}{
	...
	(*RegisteredResource)(nil),           // 25: policy.RegisteredResource
	(*RegisteredResourceValue)(nil),      // 26: policy.RegisteredResourceValue
	...
	(*keymanagement.ProviderConfig)(nil), // 31: policy.keymanagement.ProviderConfig
}
var file_policy_objects_proto_depIdxs = []int32{
	...
	30, // 18: policy.Action.metadata:type_name -> common.Metadata
	10, // 19: policy.SubjectMapping.attribute_value:type_name -> policy.Value
	16, // 20: policy.SubjectMapping.subject_condition_set:type_name -> policy.SubjectConditionSet
	11, // 21: policy.SubjectMapping.actions:type_name -> policy.Action
	30, // 22: policy.SubjectMapping.metadata:type_name -> common.Metadata
	1,  // 23: policy.Condition.operator:type_name -> policy.SubjectMappingOperatorEnum
	13, // 24: policy.ConditionGroup.conditions:type_name -> policy.Condition
	2,  // 25: policy.ConditionGroup.boolean_operator:type_name -> policy.ConditionBooleanTypeEnum
	14, // 26: policy.SubjectSet.condition_groups:type_name -> policy.ConditionGroup
	15, // 27: policy.SubjectConditionSet.subject_sets:type_name -> policy.SubjectSet
	30, // 28: policy.SubjectConditionSet.metadata:type_name -> common.Metadata
	30, // 29: policy.ResourceMappingGroup.metadata:type_name -> common.Metadata
	30, // 30: policy.ResourceMapping.metadata:type_name -> common.Metadata
	10, // 31: policy.ResourceMapping.attribute_value:type_name -> policy.Value
	18, // 32: policy.ResourceMapping.group:type_name -> policy.ResourceMappingGroup
	24, // 33: policy.KeyAccessServer.public_key:type_name -> policy.PublicKey
	30, // 34: policy.KeyAccessServer.metadata:type_name -> common.Metadata
	29, // 35: policy.Key.is_active:type_name -> google.protobuf.BoolValue
	29, // 36: policy.Key.was_mapped:type_name -> google.protobuf.BoolValue
	22, // 37: policy.Key.public_key:type_name -> policy.KasPublicKey
	20, // 38: policy.Key.kas:type_name -> policy.KeyAccessServer
	30, // 39: policy.Key.metadata:type_name -> common.Metadata
	3,  // 40: policy.KasPublicKey.alg:type_name -> policy.KasPublicKeyAlgEnum
	22, // 41: policy.KasPublicKeySet.keys:type_name -> policy.KasPublicKey
	23, // 42: policy.PublicKey.cached:type_name -> policy.KasPublicKeySet
	26, // 43: policy.RegisteredResource.values:type_name -> policy.RegisteredResourceValue
	30, // 44: policy.RegisteredResource.metadata:type_name -> common.Metadata
	25, // 45: policy.RegisteredResourceValue.resource:type_name -> policy.RegisteredResource
	30, // 46: policy.RegisteredResourceValue.metadata:type_name -> common.Metadata
	5,  // 47: policy.AsymmetricKey.key_status:type_name -> policy.KeyStatus
	6,  // 48: policy.AsymmetricKey.key_mode:type_name -> policy.KeyMode
	31, // 49: policy.AsymmetricKey.provider_config:type_name -> policy.keymanagement.ProviderConfig
	30, // 50: policy.AsymmetricKey.metadata:type_name -> common.Metadata
	5,  // 51: policy.SymmetricKey.key_status:type_name -> policy.KeyStatus
	6,  // 52: policy.SymmetricKey.key_mode:type_name -> policy.KeyMode
	31, // 53: policy.SymmetricKey.provider_config:type_name -> policy.keymanagement.ProviderConfig
	30, // 54: policy.SymmetricKey.metadata:type_name -> common.Metadata
